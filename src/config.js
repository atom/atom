  ...
  Config = class Config {
    ...
    */
    ...
    getAll(keyPath, options) {
      ...
      if (scope != null) {
        ...
        if (legacyScopeDescriptor = this.getLegacyScopeDescriptor(scopeDescriptor)) {
    ...
    */
    ...
    observeUserConfig() {
      ...
      try {
        if (this.watchSubscriptionPromise == null) { this.watchSubscriptionPromise = watchPath(this.configFilePath, {}, events => {
          return (() => {
            const result = [];
