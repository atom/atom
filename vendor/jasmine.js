...
jasmine.WaitsForBlock.prototype.execute = function (onComplete) {
  ...
  if (this.latchFunction.length > 0) {
    this.waitForExplicitCompletion(onComplete);
    return;
  }
...
jasmine.WaitsForBlock.prototype.waitForExplicitCompletion = function (
  onComplete
) {
  var self = this;
  ...
  var multiCompletion = new jasmine.WaitsForBlock.MultiCompletion(
    this.latchFunction.length,
    this.env,
    onComplete,
    timeoutHandle
  );
...
jasmine.WaitsForBlock.MultiCompletion = function (
  count,
  env,
  onComplete,
  timeoutHandle
...
jasmine.WaitsForBlock.MultiCompletion.prototype.buildCompletionFunction = function (
  i
) {
  var self = this;
  var spent = false;
