...
module.exports = (grunt) ->
  ...
  grunt.registerTask 'build', 'Build the application', ->
    ...
    if process.platform is 'darwin'
      ...
      fs.renameSync path.join(shellAppDir, 'Contents', 'Frameworks', 'Electron Helper.app'), path.join(shellAppDir, 'Contents', 'Frameworks', 'Scroll Helper.app')
      fs.renameSync path.join(shellAppDir, 'Contents', 'Frameworks', 'Scroll Helper.app', 'Contents', 'MacOS', 'Electron Helper'), path.join(shellAppDir, 'Contents', 'Frameworks', 'Scroll Helper.app', 'Contents', 'MacOS', 'Scroll Helper')
    else
