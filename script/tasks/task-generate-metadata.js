...
module.exports = function(task) {
  ...
  CONFIG.appMetadata._atomPackages = buildBundledPackagesMetadata(task);
  CONFIG.appMetadata._atomMenu = buildPlatformMenuMetadata(task);
  CONFIG.appMetadata._atomKeymaps = buildPlatformKeymapsMetadata(task);
  CONFIG.appMetadata._deprecatedPackages = deprecatedPackagesMetadata;
  CONFIG.appMetadata.version = CONFIG.computedAppVersion;
  checkDeprecatedPackagesMetadata(task);
  fs.writeFileSync(
...
function buildBundledPackagesMetadata(task) {
  task.info('Building bundled packages metadata');
...
function buildPlatformMenuMetadata(task) {
  task.info('Building platform menu metadata');
...
function buildPlatformKeymapsMetadata(task) {
  task.info('Building platform leymaps metadata');
...
function checkDeprecatedPackagesMetadata(task) {
  task.info('Checking deprecated packages metadata');
