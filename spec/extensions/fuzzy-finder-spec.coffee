...
describe 'FuzzyFinder', ->
  ...
  describe "fuzzy-finder:toggle-file-finder on the root view", ->
  ...
  describe "fuzzy-finder:toggle-buffer-finder on the root view", ->
  ...
  describe "fuzzy-finder:select-path events", ->
    [editor1, editor2] = []
