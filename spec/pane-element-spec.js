...
describe("PaneElement", function() {
      ...
      describe("when the path of the item changes", function() {
        ...
        beforeEach(function() {
          ...
          item1.setPath = function(path) {
            this.path = path;
            for (let callback of Array.from(this.changePathCallbacks)) { callback(); }
          };
          item1.getPath = function() { return this.path; };
  ...
  describe("when an item is removed from the pane", function() {
    ...
    describe("when the destroyed item is a model", () => it("removes the model's associated view", function() {
      class TestModel {}
  ...
  describe("drag and drop", function() {
    ...
    describe("when a non-file is dragged to the pane", () => it("does nothing", function() {
