            ...
            waitsForPromise(function() {
              ...
              return atom.workspace
                .scan(/aaaa/, {paths: ["dir"]}, function({filePath}) {
                  if (!Array.from(resultPaths).includes(filePath)) { return resultPaths.push(filePath); }}).then(() => expect(resultPaths).toEqual([file1]));
            });
            ...
            waitsForPromise(function() {
              ...
              return atom.workspace
                .scan(/aaaa/, {paths: [path.basename(dir2)]}, function({filePath}) {
                  if (!Array.from(resultPaths).includes(filePath)) { return resultPaths.push(filePath); }}).then(() => expect(resultPaths).toEqual([file2]));
            });
