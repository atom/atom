...
task "update-cef" => "bootstrap" do
  exit 1 unless system %{prebuilt-cef/script/download -b 1426 -r 1135 -d https://gh-contractor-zcbenz.s3.amazonaws.com/cefode/prebuilt-cef -f cef}
...
task "download-cef-symbols" => "update-cef" do
  sh %{prebuilt-cef/script/download -b 1426 -r 1135 -d https://gh-contractor-zcbenz.s3.amazonaws.com/cefode/prebuilt-cef -s cef}
end
